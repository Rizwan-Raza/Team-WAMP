...
import com.wampinfotech.teamwamp.adapters.MessageAdapter;
import com.wampinfotech.teamwamp.fragments.APIService;
import com.wampinfotech.teamwamp.models.Chat;
import com.wampinfotech.teamwamp.models.User;
import com.wampinfotech.teamwamp.notifications.Client;
import com.wampinfotech.teamwamp.notifications.Data;
import com.wampinfotech.teamwamp.notifications.MyResponse;
import com.wampinfotech.teamwamp.notifications.Sender;
import com.wampinfotech.teamwamp.notifications.Token;
...
public class MessageActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (chat.getReceiver().equals(fUser.getUid()) && chat.getSender().equals(userId)) {
                        ...
                        if (snapshot.getRef().updateChildren(hashMap).isSuccessful()) {
                            Log.e("TAG", "onDataChange: Ho gya seen");
                        } else {
                            Log.e("TAG", "onDataChange: Na hua seen");
                        }
                    }
                }
            }
    ...
    private void sendMessage(String sender, final String receiver, final String message) {
        ...
        reference.child("chats").push().setValue(chatData);
